  ...
  return (
    ...
    items-center justify-center h-full px-4 md:flex-row'>
        <div className='flex flex-col justify-center h-full'>
            <h2 className='text-4xl sm:text-7xl font-bold text-white '>  I'm a Frontend Web Developer</h2>
            <p className='text-gray-500 py-4 max-w-md'>
                I have 1 Year of Experience building and designing
                Websites.
                Currently, I love to work on Web aaplications using technologies like
                React, Tailwind, Bootstrap and Vue.js .
                I have recently Cleared Aws Cloud Practioner . 
            </p>
            <div>
